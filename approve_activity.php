...
<div class="row">
<div class="col-md-12">
<div class="box"><div class="box-header"><i class="fa fa-cog"></i><h3 class="box-title">Event view</h3><div class="box-tools pull-right"><a class="btn btn-info" style="color:#fff !important;" href="approve.php?id=<?php echo $gets['id']; ?>">Approve</a></div></div>
<div class="box-body">
<div id="calendar"></div>
</div>
</div>
